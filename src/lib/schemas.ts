...
export const compteBancaireSchema = z.object({
  ...
  adressetitulaire: z.string().min(2, "L'adresse du titulaire doit contenir au moins 2 caractères").optional().or(z.literal('')),
  domiciliation: z.string().min(2, 'La domiciliation est requise').optional().or(z.literal('')),
  adressedomiciliation: z
    .string()
    .min(2, "L'adresse de domiciliation doit contenir au moins 2 caractères").optional().or(z.literal('')),
